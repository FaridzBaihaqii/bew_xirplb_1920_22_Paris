                  ...
                  <?php foreach ($data as $row) : ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href="<?= URL ?>edit&id=<?= $row["nisn"]; ?>"><button class="blue_button"><i class="fa-solid fa-pen-to-square"></i></button></a>
                          <a href="<?= URL ?>detail&id=<?= $row["nisn"]; ?>"><button class="light_button"><i class="fa-solid fa-book"></i></button></a>
                          <a href="<?= URL ?>hapus&id=<?= $row["nisn"]; ?>"><button class="red_button"><i class="fa-solid fa-trash"></i></button></a>
                        </td>
                      </tr>
                      <tr>
                        <td></td>
