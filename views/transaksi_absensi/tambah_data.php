                        ...
                        <div class="table">
                            ...
                            <div class="table_selection">
                                ...
                                <div class="container-form">
                                    <form action="<?= URL ?>prosestambah" method="POST" autocomplete="off" enctype="multipart/form-data">
                                        <div class="box">
                                            <div>

                                                <!-- KODE -->
                                                <label>Id_kehadiran : </label><br>
                                                <input type="int" name="int_kehad" required><br>

                                                <!-- NAMA -->
                                                <label>Nisn : </label><br>
                                                <input type="text" name="char_nisn" required><br>
                                            ...
                                            <div class="space">
                                                ...
                                                <input type="radio" name="rd_status" value="M">Masuk<br>
                                                <input type="radio" name="rd_status" value="TM">Tidak Masuk<br>

                                                <br>

                                                <!-- GAMBAR -->
                                                <label>Keterangan : </label><br>
                                                <input type="text" name="txt_keter" required><br>
