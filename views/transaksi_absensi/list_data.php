                  ...
                  <?php foreach ($data as $row) : ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href="<?= URL ?>edit&id=<?= $row["id_kehadiran"]; ?>"><button class="blue_button"><i class="fa-solid fa-pen-to-square"></i></button></a>
                          <a href="<?= URL ?>detail&id=<?= $row["id_kehadiran"]; ?>"><button class="light_button"><i class="fa-solid fa-book"></i></button></a>
                          <a href="<?= URL ?>hapus&id=<?= $row["id_kehadiran"]; ?>"><button class="red_button"><i class="fa-solid fa-trash"></i></button></a>
                        </td>
                      </tr>
                      <tr>
                        <td></td>
